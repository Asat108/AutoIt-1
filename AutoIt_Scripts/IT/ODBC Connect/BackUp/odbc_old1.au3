...
;
;===============================================================================
Func _SQLConnect($sServer, $sDatabase, $fAuthMode = 0, $sUsername = "", $sPassword = "", $sDriver = "{iSeries Access ODBC Driver}")
...
$sqlCon.Open("DRIVER={iSeries Access ODBC Driver};SERVER=JEWELRYSUPPLY;DATABASE=JS1380BFJS;UID=wse;PWD=wse;")
